...
void LevelClearedWidget::render(sf::RenderTarget *renderTarget) {
...
void LevelClearedWidget::handleEvent(sf::Event ev, sf::Vector2f mousePosition) {
...
void LevelClearedWidget::onEvent(const std::string &eventName) {
